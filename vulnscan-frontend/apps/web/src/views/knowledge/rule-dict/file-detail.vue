...
defineOptions({ name: 'RuleDictFileDetail' });
...
const entryColumns = computed<DataTableColumns<FileEntry>>(() => [
  ...
  { key: 'mark', title: '标记', minWidth: 150, ellipsis: { tooltip: true } },
  {
    key: 'risk',
    title: '风险',
    width: 100,
...
function handleImportFileChange({ fileList }: { fileList: UploadFileInfo[] }) {
