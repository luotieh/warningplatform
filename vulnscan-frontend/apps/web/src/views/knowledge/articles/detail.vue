...
defineOptions({ name: 'KnowledgeArticleDetail' });
    ...
    <NSpin :show="loading">
      <template v-if="article">
        ...
        <NCard title="相关文章" size="small" v-if="related.length">
          <div v-for="r in related" :key="r.id" style="padding:6px 0;border-bottom:1px solid #f0f0f0;cursor:pointer" @click="router.push(`/knowledge/articles/${r.id}`)">
