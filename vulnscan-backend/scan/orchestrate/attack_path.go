...
func (a *AttackPathAnalyzer) Analyze(targets []*core.Target, findings []*core.Finding) []AttackPath {
	hostFindings := make(map[string][]*core.Finding)
	hostTargets := make(map[string][]*core.Target)
...
func (a *AttackPathAnalyzer) buildPath(host string, targets []*core.Target, findings []*core.Finding) AttackPath {
...
func (a *AttackPathAnalyzer) generateSuggestions(host string, targets []*core.Target, findings []*core.Finding, typeCount map[string]int) []string {
