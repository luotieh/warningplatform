...
func TestDedup_SameTaskSameFinding(t *testing.T) {
	...
	f := &core.Finding{
		ModuleID: "test_mod",
		Target:   &core.Target{Host: "example.com", IP: "1.1.1.1", Port: 80},
		Type:     "vuln",
		Title:    "SQLi",
	}
...
func TestDedup_DeduplicateFindings(t *testing.T) {
	...
	findings := []*core.Finding{
		{ModuleID: "m1", Target: &core.Target{Host: "a.com", Port: 80}, Type: "vuln", Title: "SQL Injection", Timestamp: now},
		{ModuleID: "m1", Target: &core.Target{Host: "a.com", Port: 80}, Type: "vuln", Title: "SQL Injection", Timestamp: now},
		{ModuleID: "m1", Target: &core.Target{Host: "b.com", Port: 80}, Type: "vuln", Title: "SQL Injection", Timestamp: now},
	}
...
func TestDedup_Count(t *testing.T) {
	...
	d.IsDuplicate("t1", &core.Finding{ModuleID: "m", Target: &core.Target{Host: "a"}, Type: "v", Title: "1"})
	d.IsDuplicate("t1", &core.Finding{ModuleID: "m", Target: &core.Target{Host: "b"}, Type: "v", Title: "2"})
...
func TestDedup_Reset(t *testing.T) {
	d := NewFindingDeduplicator(false)
	d.IsDuplicate("t1", &core.Finding{ModuleID: "m", Target: &core.Target{}, Type: "v", Title: "1"})
	d.Reset()
...
func TestDedup_NilTarget(t *testing.T) {
	d := NewFindingDeduplicator(false)
	f := &core.Finding{ModuleID: "m", Target: nil, Type: "v", Title: "no-target"}
