...
func (m *XMLRPCScannerModule) Run(ctx context.Context, targets []*Target, config map[string]interface{}) (*ModuleResult, error) {
	start := time.Now()
...
func (m *XMLRPCScannerModule) scanTarget(ctx context.Context, target *Target) []*Finding {
...
func (m *XMLRPCScannerModule) checkXMLRPCExists(ctx context.Context, url string, target *Target) *Finding {
...
func (m *XMLRPCScannerModule) checkPingbackAbuse(ctx context.Context, url string, target *Target) *Finding {
	payload := `<?xml version="1.0" encoding="utf-8"?>
<methodCall>
...
func (m *XMLRPCScannerModule) checkBruteForce(ctx context.Context, url string, target *Target) *Finding {
	payload := `<?xml version="1.0" encoding="utf-8"?>
<methodCall>
...
func (m *XMLRPCScannerModule) checkDDoSAmp(ctx context.Context, url string, target *Target) *Finding {
	payload := `<?xml version="1.0" encoding="utf-8"?>
<methodCall>
