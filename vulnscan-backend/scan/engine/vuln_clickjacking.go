...
func (m *ClickjackingScannerModule) Run(ctx context.Context, targets []*Target, config map[string]interface{}) (*ModuleResult, error) {
	start := time.Now()
...
func (m *ClickjackingScannerModule) scanTarget(ctx context.Context, target *Target) *Finding {
