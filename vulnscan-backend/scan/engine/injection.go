...
func ExtractInjectionPoints(target *Target) []InjectionPoint {
...
func BuildInjectedRequest(ctx context.Context, target *Target, point InjectionPoint, payload string) (*http.Request, error) {
	parsed, err := url.Parse(target.URL)
	if err != nil {
		return nil, err
	}
