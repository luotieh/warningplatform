...
func (m *CRLFScannerModule) Run(ctx context.Context, targets []*Target, config map[string]interface{}) (*ModuleResult, error) {
	start := time.Now()
...
func (m *CRLFScannerModule) scanTarget(ctx context.Context, target *Target) []*Finding {
