...
func (m *HTTPSmugglingScannerModule) Run(ctx context.Context, targets []*core.Target, config map[string]interface{}) (*core.ModuleResult, error) {
	start := time.Now()
...
func (m *HTTPSmugglingScannerModule) scanTarget(ctx context.Context, target *core.Target) []*core.Finding {
...
func (m *HTTPSmugglingScannerModule) testCLTE(ctx context.Context, addr string, target *core.Target) *core.Finding {
...
func (m *HTTPSmugglingScannerModule) testTECL(ctx context.Context, addr string, target *core.Target) *core.Finding {
	payload := "POST / HTTP/1.1\r\n" +
		"Host: " + target.Host + "\r\n" +
		"Content-Length: 4\r\n" +
		"Transfer-Encoding: chunked\r\n" +
