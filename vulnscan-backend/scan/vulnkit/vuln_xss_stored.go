...
func (m *XSSStoredScannerModule) Run(ctx context.Context, targets []*core.Target, config map[string]interface{}) (*core.ModuleResult, error) {
	start := time.Now()
...
func (m *XSSStoredScannerModule) scanTarget(ctx context.Context, target *core.Target) []*core.Finding {
...
func (m *XSSStoredScannerModule) discoverForms(ctx context.Context, target *core.Target) []formInfo {
	var forms []formInfo
