...
func (m *SensitiveDataScannerModule) Run(ctx context.Context, targets []*core.Target, config map[string]interface{}) (*core.ModuleResult, error) {
	start := time.Now()
...
func (m *SensitiveDataScannerModule) scanTarget(ctx context.Context, target *core.Target) []*core.Finding {
