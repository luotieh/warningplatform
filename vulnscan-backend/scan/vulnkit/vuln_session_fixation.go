...
func (m *SessionFixationScannerModule) Run(ctx context.Context, targets []*core.Target, config map[string]interface{}) (*core.ModuleResult, error) {
	start := time.Now()
...
func (m *SessionFixationScannerModule) scanTarget(ctx context.Context, target *core.Target) []*core.Finding {
