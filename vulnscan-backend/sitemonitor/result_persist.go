...
func SaveSensitiveWordResult(tx *gorm.DB, execID, taskID string, r *model.MonitorSensitiveWordResult) error {
...
func SaveSensitiveFileResult(tx *gorm.DB, execID, taskID string, r *model.MonitorSensitiveFileResult) error {
	...
	return tx.CreateInBatches(findings, 100).Error
}
