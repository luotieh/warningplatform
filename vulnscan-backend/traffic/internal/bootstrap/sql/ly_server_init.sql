...
INSERT INTO `t_agent` VALUES (1,'分析节点1','127.0.0.1','admin','disconnected','本地服务','N','');
...
CREATE TABLE `t_device` (
  ...
  `pcap_level` int(11) DEFAULT '2',
  `template` varchar(600) DEFAULT NULL,
  `filter` varchar(600) DEFAULT NULL,
...
INSERT INTO `t_device` VALUES (3,'采集节点1','router','v4',1,'admin','','127.0.0.1',9995,'N','netflow',2,'',NULL,'ens224');
...
INSERT INTO `t_event_config_sus` VALUES (1,'Bps',1,NULL);
...
INSERT INTO `t_event_list` VALUES (1,7,1,7,'1',1,'Dns tunnel traffic','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(2,5,1,1,'1',2,'Blacklist traffic Bps (>1)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(3,2,1,7,'1',3,'Scan peers (>1k)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(4,2,2,6,'1',4,'SSH peers (>300)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(5,2,3,6,'1',5,'RDP peers (>300)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(6,3,1,7,'1',6,'Service sessions (>3k)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(7,3,2,6,'1',7,'SSH sessions (>300)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(8,3,3,6,'1',8,'RDP sessions (>300)','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(9,4,1,7,'1',9,'Ti domain query','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(10,13,1,7,'1',10,'Threat','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(11,6,1,7,'1',11,'Ti IP','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(12,15,1,7,'1',12,'Mining','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(13,12,1,1,'1',13,'DGA','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(14,11,1,1,'1',14,'ICMP Tunnel','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within'),(15,8,1,1,'1',15,'IP scan init config','1970-01-01 00:00:00',NULL,'0,1,2,3,4,5,6','00:00:00','23:59:59','within');
...
INSERT INTO `t_internal_ip_list` VALUES (1,'0.0.0.0/0','',3);
