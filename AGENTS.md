...
- **后端**：[template-backend/AGENTS.md](template-backend/AGENTS.md) -- 路由注册、Handler/Service 模式、Wire 依赖注入、IAM SDK 集成、Core 核心库
- **前端**：[template-frontend/AGENTS.md](template-frontend/AGENTS.md) -- 权限系统、API 模块规范、CRUD 页面模式、共享组件、Composables
